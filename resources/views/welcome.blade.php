...
<html>
    <head>
        <title>Driver Signup Bonus</title>
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
                    ...
                    <div class="home-content">
                        <div class="home-text">
                            ...
                            <div class="local-scroll">
                                <a href="#uber" class="btn btn-mod btn-border-w btn-medium btn-round hidden-xs">Drive with Uber</a>
                                <span class="hidden-xs">&nbsp;</span>
                                <a href="#lyft" class="btn btn-mod btn-border-w btn-medium btn-round hidden-xs">Drive with Lyft</a>
                            </div>
            ...
            <!-- Uber Section -->
            <section class="page-section" id="uber">
            ...
            <!-- Lyft Section -->
            <section class="page-section" id="lyft">
                <div class="container relative">
